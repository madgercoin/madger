...
if (!homepage.includes('class="hero hero-showcase utility-first-hero"') || !homepage.includes("YOUR WAY INTO THE BURROW") || !homepage.includes('href="/commons"><b>02</b><span>Use the Commons')) failures.push("index.html: utility-first value proposition is absent");
if (!homepage.includes('class="hero-actions hero-actions--purchase"') || !homepage.includes('class="button guide" href="/buy">Beginner Guide') || !homepage.includes("Buy on Raydium")) failures.push("index.html: distinct beginner and experienced buying paths are absent");
