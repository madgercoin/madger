...
if (!home.includes('class="hero-actions hero-actions--purchase"') || !home.includes('class="button guide" href="/buy">Beginner Guide') || !home.includes("Buy on Raydium")) failures.push("index.html: distinct beginner and experienced buying paths are absent");
