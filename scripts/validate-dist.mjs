...
const publicOperationsAddresses = [
...
const launchPage = await readFile(path.join("dist", "launch.html"), "utf8");
const missingPublicAddresses = publicOperationsAddresses.filter(address => !launchPage.includes(address));
