...
| `madger_social_share_v8.jpg` | `/assets/madger_social_share_v8.jpg` | 1200×630 JPEG branded link-preview card for Open Graph and X |

## Canonical mascot

The approved character is a cute, trustworthy 3D Honey Badger with black-and-cream fur, a lightning-shaped forehead stripe, large round eyes, and a tiny fang. The gold-edged face emblem is the canonical compact mark; standing crossed-arm renders are retired and must not be used.
