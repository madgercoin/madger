...
The selected launch design is a direct MADGER/SOL Raydium CPMM liquidity pool scheduled conditionally for August 31, 2026 at 14:00 UTC. This replaces the stale bonding-curve venue reference: MADGER is already minted and is not using a bonding curve or graduation mechanism.
