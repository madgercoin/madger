...
export default function VerifyScreen() {
  ...
  async function copyMint() {
    if (!await Clipboard.setStringAsync(MINT)) throw new Error('Clipboard unavailable');
    setCopied(true);
  ...
  return <Screen>
    ...
    {copied ? <Text accessibilityRole="alert" accessibilityLiveRegion="polite" style={textStyles.body}>Full mint address copied.</Text> : null}
