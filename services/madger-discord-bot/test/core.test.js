...
test('moderation catches a fake MADGER mint but preserves the official mint', () => {
  ...
  assert.equal(moderationFinding('Wallet 4J48uQqrHEfDjvJwG3kpoQMPbsyGe5yWLmjBPDiJ4vZu is unrelated. MADGER contract 4J48uQqrHEfDjvJwG3kpoQMPbsyGe5yWLmjBPDiJ4vZu').reason, 'unverified MADGER contract address')
})
...
test('wallet safety education is not mistaken for credential theft', () => {
  ...
  assert.equal(moderationFinding('Never share your seed phrase. DM me your seed phrase').severity, 'critical')
})
